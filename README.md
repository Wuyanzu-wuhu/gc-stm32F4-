...
> 从 **STM32F407、DMA 串口、姿态闭环、K230 视觉** 到 **四麦轮车身漂移与机械臂协同** 的竞赛项目学习记录。
...
**补充一下世界坐标系，下面这个是世界坐标系(我调试的时候是用了这个坐标系，如果觉得跟平时学的二维坐标系不同，可以自行改正哦)**![世界坐标系.bmp](%CA%C0%BD%E7%D7%F8%B1%EA%CF%B5.bmp)
